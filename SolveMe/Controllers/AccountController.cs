        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    string activationLink = "http://localhost:" + HttpContext.Request.Url.Port.ToString() +
                                            "/Account/Activate/" + model.UserName + "/" + confirmationToken;
                    EmailSender emailSender = new EmailSender(activationLink, model.UserName);
                    emailSender.Send();
                    return View("Thanks");
                }
